...
/**
 * @brief Exporter les produits
 */
void MainWindow::on_actionExportProduits_triggered() {
    ...
    m_database->exportData(req,"Produits");
}
...
void MainWindow::on_actionServices_triggered() {
    QString req = "SELECT *"
            " FROM TAB_SERVICES";
    m_database->exportData(req,"Services");
}
/**
 * @brief Exporter les clients
 */
void MainWindow::on_actionClientsEx_triggered() {
    QString req = "SELECT * FROM TAB_CUSTOMERS";
    m_database->exportData(req,"Clients");
}
/**
 * @brief Exporter les fournisseurs
 */
void MainWindow::on_actionFournisseurs_triggered() {
    QString req = "SELECT * FROM TAB_PROVIDERS";
    m_database->exportData(req,"Fournisseurs");
}
